...
import com.deloitte.inv.application.model.QualityResultsDBOutput;


/**
 *  Service class that provides CRUD and custom operations against the qualityResultsDBOutput data object.
 *  The behavior of this class is driven by the qualityResultsDBOutput classMappingDescriptor in persistence-mapping.xml.
 *
 ...
 */
public class QualityResultsDBOutputService extends EntityCRUDService<QualityResultsDBOutput> {

    /**
     * Default constructor. If autoQuery is set to true in the classMappingDescriptor in persistence-mapping.xml, then
     * the findAll method will be executed and the qualityResultsDBOutput list will be populated when this constructor is invoked.
     ...
     *
     * QualityResultsDBOutputService crudService = (QualityResultsDBOutputService) EntityUtils.getEntityCRUDService(QualityResultsDBOutput.class);
     *
     ...
     * data control there.
     */
    public QualityResultsDBOutputService() {
    }
     ...
     */
    public QualityResultsDBOutputService(boolean autoQuery) {
        super(autoQuery);
    }
     ...
     */
    public QualityResultsDBOutputService(boolean doRemoteReadInBackground, boolean doRemoteWriteInBackground) {
        super(false);
    ...
    protected Class getEntityClass() {
        return QualityResultsDBOutput.class;
    }

    protected String getEntityListName() {
        return "qualityResultsDBOutput";
    }

    public List<QualityResultsDBOutput> getQualityResultsDBOutput() {
        return getEntityList();
    }

    /**
     * This method is automatically called when using the Create operation on the qualityResultsDBOutput collection
     * in the data control palette.
     *
     * Note that this method does NOT add the qualityResultsDBOutput to the entity list because this method is
     ...
     * logic there. The CDM EntityList class ensures that this method is called after a qualityResultsDBOutput has been added.
     ...
     * instead to ensure that iterator binding and qualityResultsDBOutput list stay in sync.
     * @param index
     * @param qualityResultsDBOutput
     */
    public void addQualityResultsDBOutput(int index, QualityResultsDBOutput qualityResultsDBOutput) {
        addEntity(index, qualityResultsDBOutput);
    }

    /**
     * Sets qualityResultsDBOutput state to new, and if addToList argument is true, it adds the qualityResultsDBOutput to the
     * qualityResultsDBOutput list and and fires change event to refresh the list in the UI
     * @param index
     * @param qualityResultsDBOutput
     * @param addToList
     */
    public void addQualityResultsDBOutput(int index, QualityResultsDBOutput qualityResultsDBOutput, boolean addToList) {
        addEntity(index, qualityResultsDBOutput, addToList);
    }

    /**
     * This method is automatically called when using the Delete operation on the qualityResultsDBOutput collection
     ...
     *
     * Note that this method does NOT remove the qualityResultsDBOutput from the entity list because this method is
     ...
     * logic there. The CDM EntityList class ensures that this refresh method is called after a qualityResultsDBOutput has been added.
     *
     * Do NOT drag and drop this method from the data control palette, use the Delete operation
     * instead to ensure that iterator binding and qualityResultsDBOutput list stay in sync.
     * @param qualityResultsDBOutput
     */
    public void removeQualityResultsDBOutput(QualityResultsDBOutput qualityResultsDBOutput) {
        removeEntity(qualityResultsDBOutput);
    }


    /**
     * Removes a qualityResultsDBOutput using the configured local and remote persistence managers.
     * If removeFromList argument is true, it removes the qualityResultsDBOutput from the
     * a qualityResultsDBOutput list and and fires change event to refresh the list in the UI
     * @param a qualityResultsDBOutput
     * @param removeFromList
     */
    public void removeQualityResultsDBOutput(QualityResultsDBOutput qualityResultsDBOutput, boolean removeFromList) {
        removeEntity(qualityResultsDBOutput, removeFromList);
    }

    /**
     * Inserts or updates a qualityResultsDBOutput using the configured persistence managers.
     * The insert or update is determined by calling isNewEntity on the qualityResultsDBOutput instance.
     * @param qualityResultsDBOutput
     */
    public void saveQualityResultsDBOutput(QualityResultsDBOutput qualityResultsDBOutput) {
        super.mergeEntity(qualityResultsDBOutput);
    }

    /**
     * Retrieves all qualityResultsDBOutput instances using the configured persistence managers and populates the qualityResultsDBOutput list
     * with the result.
     ...
     */
    public void findAllQualityResultsDBOutput() {
        super.findAll();
    }

    /**
     * Retrieves all qualityResultsDBOutput instances using the findAll method on the remote persistence manager
     * and populates the qualityResultsDBOutput list
     */
    public void findAllQualityResultsDBOutputRemote() {
        super.doRemoteFindAll();
    }

    /**
     * Retrieves the qualityResultsDBOutput instances that match the searchValue filter using the configured persistence
     * managers and populates the qualityResultsDBOutput list with the result.
     ...
     * @param searchValue
     */
    public void findQualityResultsDBOutput(String searchValue) {
        super.find(searchValue);
    }


    /**
     * Resets the values of the qualityResultsDBOutput instance to the values as stored in the SQLite database. This method
     * will do nothing when the qualityResultsDBOutput is not persisted to the database.
     * @param qualityResultsDBOutput
     */
    public void resetQualityResultsDBOutput(QualityResultsDBOutput qualityResultsDBOutput) {
        super.resetEntity(qualityResultsDBOutput);
    }
